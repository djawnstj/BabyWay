...
enum class ErrorCode(
    ...
    // MEMBER
    BLANK_LOGIN_ID(HttpStatus.BAD_REQUEST, "아이디 값이 없습니다."),
    INVALID_LOGIN_ID_FORMAT(HttpStatus.BAD_REQUEST, "아이디는 영어(필수), 숫자, 특수문자로 이루어진 8자 이상 15자 이하여야 합니다."),
    BLANK_PASSWORD(HttpStatus.BAD_REQUEST, "비밀번호 값이 없습니다."),
    INVALID_PASSWORD_FORMAT(HttpStatus.BAD_REQUEST, "비밀번호는 영어(필수), 숫자(필수), 특수문자로 이루어진 8자 이상 15자 이하여야 합니다."),
    ...
    DUPLICATED_REGISTER_LOGIN_ID(HttpStatus.CONFLICT, "이미 존재 하는 아이디 입니다."),
